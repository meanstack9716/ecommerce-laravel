...
<div class="p-4 sm:p-8 w-full">
    <div class="bg-white shadow-md rounded-lg border border-gray-200 p-4 xl:p-8 w-full space-y-6">
        ...
        <form method="GET" action="{{ route('orders.list') }}" class="flex flex-col sm:flex-row justify-between sm:items-center gap-3 mb-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 items-center gap-y-3 gap-x-8 w-full">
                ...
                <div class="flex flex-col items-start gap-2">
                    ...
                    <div class="relative w-full">
                        <select name="sellerId" onchange="this.form.submit()" class="border cursor-pointer border-gray-300 rounded-lg px-4 py-2 appearance-none w-full">
                ...
                @endif
                 ...
                 <div class="flex flex-col items-start gap-2">
                    ...
                    <div class="relative w-full">
                        <select name="staus" onchange="this.form.submit()" class="border cursor-pointer border-gray-300 rounded-lg px-4 py-2 appearance-none w-full">
            ...
            <table class="min-w-full table-auto">
                <thead class="bg-indigo-100 text-gray-700">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-center text-sm font-medium text-gray-500 uppercase tracking-wider min-w-60">Payent Method</th>
        ...
        <div class="pt-4 flex flex-col sm:flex-row justify-between items-center gap-3">
            ...
            <div class="min-w-1/2">
                {{ $orders->appends(['limit' => $limit])->links() }}
            </div>
        </div>
    </div>
</div>
